...
<form action="<?php echo JRoute::_('index.php?option=com_jereverseauction'); ?>" method="post" name="adminForm" id="adminForm">
	<table border="0" id="products" width="100%" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td>
					<div id="products">
						<div id="page_title"><?php echo JText::_('COM_JEREVERSE_AUCTION_ENDED_PRODUCTS'); ?></div>
						<?php
						if($n){
						...
						<div id="prod_container">
							...
							<div id="opens"><?php echo JText::_('COM_JEREVERSE_AUCTION_ENDS'); ?></div>
							<div id="prod_price"><span id="currency"><?php echo $currency;?></span><?php echo $val->prod_amount;?></div>
							<div id="prod_price"><span><?php echo JText::_('COM_JEREVERSE_AUCTION_WINNER'); ?></span><span class="winner"><?php if($val->user_name)echo $val->user_name;else echo JText::_('COM_JEREVERSE_AUCTION_NO_WINNER');?></span></div>
